...
export PYTHONPATH=/data/share/boss/sglang/python:$PYTHONPATH

# 内存碎片
export PYTORCH_NPU_ALLOC_CONF=expandable_segments:True
export STREAMS_PER_DEVICE=32
# pd传输, IP设置为p节点首节点
export ASCEND_MF_STORE_URL="tcp://172.19.2.7:24707"
export SGLANG_DISAGGREGATION_BOOTSTRAP_TIMEOUT=600

# p节点IP
P_IP=('172.19.2.7' '172.19.2.9')
# D节点IP D节点首节点IP
D_IP=('172.19.2.11' '172.19.2.17')

#MODEL_PATH=/data/models/GLM-5.1-w8a8
MODEL_PATH=/data/share/models/GLM-5-w4a8
...
do
    ...
    #     export DEEPEP_NORMAL_COMBINE_ENABLE_LONG_SEQ=1
        ...
        export HCCL_SOCKET_IFNAME=enp196s0f1
        export GLOO_SOCKET_IFNAME=enp196s0f1
        ### eplb
        ...
        export SGLANG_ZBAL_BOOTSTRAP_URL="tcp://172.19.2.7:24672"
        ...
        --port 8000 --disaggregation-bootstrap-port 8998 --dist-init-addr 172.19.2.7:5000 --trust-remote-code --nnodes 2 --node-rank $i \
        ...
        --served-model-name glm-5 --chunked-prefill-size 32768 --max-prefill-tokens 180000 --moe-a2a-backend deepep --deepep-mode normal \
...
do
    ...
    then
     ...
     export SGLANG_SPEC_ENABLE_OVERLAP_REFLOW=1
        ...
        --port 8003 --trust-remote-code --dist-init-addr 172.19.2.11:5000 --nnodes 2 --node-rank $i --tp-size 32 --dp-size 32 --ep-size 32 \
