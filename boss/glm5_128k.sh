...
# export PYTHONPATH=/home/chenxu/sglang/python:$PYTHONPATH
export PYTHONPATH=/home/luochen/glm/sglang_pp_mtp/sglang/python:$PYTHONPATH
...
# pd传输, IP设置为p节点首节点
export ASCEND_MF_STORE_URL="tcp://61.47.19.68:24709"
...
P1_IP=('61.47.19.75' '61.47.19.76')

# D节点IP D节点首节点IP
# D_IP=('61.47.19.70' '61.47.19.71' '61.47.19.75' '61.47.19.76')
...
do
    ...
    #     export DEEPEP_NORMAL_COMBINE_ENABLE_LONG_SEQ=1
        ...
        # export SGLANG_PP_LAYER_PARTITION=19,20,20,19
...
do
    ...
    then
        ...
        --port 8003 --trust-remote-code --dist-init-addr ${D_IP[0]}:5000 --nnodes 2 --node-rank $i --tp-size 32 --dp-size 16 --enable-dp-attention --ep-size 32 \
        --mem-fraction-static 0.85 --max-running-requests 96 --attention-backend ascend --device npu --quantization modelslim \
        ...
        --tokenizer-worker-num 32 --prefill-round-robin-balance --disable-shared-experts-fusion --dtype bfloat16  --load-balance-method round_robin \
        --speculative-draft-model-quantization unquant \
