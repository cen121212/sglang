...
# p节点IP
#P_IP=('61.47.19.70' '61.47.19.77' '61.47.19.78' '61.47.19.79')
P_IP=('61.47.19.68' '61.47.19.67')
# D节点IP D节点首节点IP
#D_IP=('61.47.19.68' '61.47.19.79')
...
do
    ...
    then
     ...
     export SGLANG_SPEC_ENABLE_OVERLAP_REFLOW=1
        ...
        --port 8003 --trust-remote-code --dist-init-addr 61.47.19.70:5000 --nnodes 2 --node-rank $i --tp-size 32 --dp-size 32 --ep-size 32 \
